...
/**
 * JDBC-backed implementation of the equipment booking data access contract.
 * @author Jiaying Chen
 */
public class EquipmentBookingDaoImpl implements EquipmentBookingDao {
    ...
    /**
     * Persists a new booking and returns the generated identifier.
     *
     * @param booking the booking to save
     * @return the generated booking identifier, or -1 if one was not generated
     */
    @Override
    ...
    /**
     * Retrieves all bookings associated with a particular equipment asset.
     *
    ...
    /**
     * Retrieves bookings that conflict with the supplied time range.
     *
