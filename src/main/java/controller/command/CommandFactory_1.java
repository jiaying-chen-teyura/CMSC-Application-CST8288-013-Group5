...
import controller.command.CheckInEquipmentCommand;
import java.util.HashMap;
import java.util.Map;

/**
 * Simple Factory - maps the "action" request parameter to a Command
 * instance for ControllerServlet (the Front Controller). This is separate
 * infrastructure from the graded Simple Factory pattern instance
 * (businesslayer.factory.EquipmentFactory) - see the pattern table in
 * README.md.
 */
